...
import 'package:thot/features/media/presentation/shared/widgets/audio_player_preview.dart';
...
class _NewPodcastScreenState extends State<NewPodcastScreen> {
  ...
  Future<void> _handleAudioSelected(File file) async {
    try {
      ...
      SafeNavigation.showSnackBar(
        context,
        SnackBar(
          content: Text('Erreur lors de la sélection de l\'audio: ${e.toString()}'),
  ...
  Future<void> _submitPodcast() async {
    ...
    if (_selectedAudio == null && _existingAudioUrl == null) missingItems.add('audio');
