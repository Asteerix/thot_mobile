...
class _FeedItemState extends State<FeedItem>
  ...
  Color _getTypeColor(PostType type) {
    return switch (type) {
      ...
      PostType.live => Theme.of(context).colorScheme.error,
      PostType.poll => Theme.of(context).colorScheme.primary,
      PostType.testimony => AppColors.success,
      PostType.documentation => Theme.of(context).colorScheme.primary,
