...
import 'package:thot/features/admin/widgets/report_helpers.dart';
import 'package:thot/features/admin/widgets/engagement_metrics.dart';
        ...
        Row(
          children: [
            Icon(
              ...
              color:
                  PostHelpers.getPostTypeColor(context, targetDetails['type']),
          ...
          Row(
            children: [
              CircleAvatar(
                radius: 20,
                backgroundImage:
                    targetDetails['journalist']?['avatarUrl'] != null
      ...
      children: [
        CircleAvatar(
          ...
          backgroundImage: targetDetails['avatarUrl'] != null
              ? NetworkImage(
                  ImageUtils.getAvatarUrl(targetDetails['avatarUrl']))
              : null,
