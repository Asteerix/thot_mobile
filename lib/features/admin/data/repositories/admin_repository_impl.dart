...
class AdminRepositoryImpl implements AdminRepository {
  ...
  Future<Map<String, dynamic>> getAdminStats() async {
    final response =
        await _apiService.get(ApiRoutes.buildPath(ApiRoutesHelper.adminStats));
  ...
  Future<Map<String, dynamic>> getDetailedJournalistStats({
    ...
    final uri = Uri.parse(ApiRoutesHelper.adminJournalistStatsDetailed)
  ...
  Future<Map<String, dynamic>> getJournalists({
    ...
    final uri = Uri.parse(ApiRoutes.buildPath(ApiRoutesHelper.adminJournalists))
  ...
  Future<List<Map<String, dynamic>>> getVerifiedJournalists() async {
    final response = await _apiService
        .get(ApiRoutes.buildPath(ApiRoutesHelper.adminJournalistsVerified));
  ...
  Future<List<Map<String, dynamic>>> getPendingJournalists() async {
    final response = await _apiService
        .get(ApiRoutes.buildPath(ApiRoutesHelper.adminJournalistsPending));
    final journalists = response.data['data'] as List? ?? [];
    return journalists.cast<Map<String, dynamic>>();
  }
  Future<List<Map<String, dynamic>>> getRejectedJournalists() async {
    final response = await _apiService
        .get(ApiRoutes.buildPath(ApiRoutesHelper.adminJournalistsRejected));
    final journalists = response.data['data'] as List? ?? [];
    return journalists.cast<Map<String, dynamic>>();
  }
  Future<Map<String, dynamic>> approveJournalist(String journalistId,
    ...
    final response = await _apiService.put(
      ApiRoutes.buildPath(ApiRoutesHelper.adminApproveJournalist(journalistId)),
      data: body,
    );
    return response.data ?? {};
  }
  Future<Map<String, dynamic>> rejectJournalist(
    ...
    if (notes != null && notes.isNotEmpty) body['notes'] = notes;
    final response = await _apiService.put(
      ApiRoutes.buildPath(ApiRoutesHelper.adminRejectJournalist(journalistId)),
      data: body,
    );
    return response.data ?? {};
  }
  Future<Map<String, dynamic>> unverifyJournalist(
    ...
    final response = await _apiService.put(
      ApiRoutes.buildPath(
          ApiRoutesHelper.adminUnverifyJournalist(journalistId)),
      data: body,
    );
    return response.data ?? {};
  }
  Future<Map<String, dynamic>> getPosts({
    ...
    if (status != null && status.isNotEmpty) queryParams['status'] = status;
    final uri = Uri.parse(ApiRoutes.buildPath(ApiRoutesHelper.adminPosts))
        .replace(queryParameters: queryParams);
    final response = await _apiService.get(uri.toString());
    return response.data ?? {};
  }
  Future<Map<String, dynamic>> deletePost(
    ...
    final response = await _apiService.delete(
      ApiRoutes.buildPath(ApiRoutesHelper.adminDeletePost(postId)),
      data: body,
    );
    return response.data ?? {};
  }
  Future<Map<String, dynamic>> getUsers({
    ...
    if (status != null && status.isNotEmpty) queryParams['status'] = status;
    final uri = Uri.parse(ApiRoutes.buildPath(ApiRoutesHelper.adminUsers))
        .replace(queryParameters: queryParams);
    final response = await _apiService.get(uri.toString());
    return response.data ?? {};
  }
  Future<Map<String, dynamic>> suspendUser(
    ...
    final response = await _apiService.put(
      ApiRoutes.buildPath(ApiRoutesHelper.adminSuspendUser(userId)),
      data: body,
    );
    return response.data ?? {};
  }
  Future<Map<String, dynamic>> updateUserRole(
    ...
    final response = await _apiService.put(
      ApiRoutes.buildPath(ApiRoutesHelper.adminUpdateUserRole(userId)),
      data: {'role': role},
    );
    return response.data ?? {};
  }
  Future<Map<String, dynamic>> getAuditLogs({
    ...
    final uri = Uri.parse(ApiRoutes.buildPath(ApiRoutesHelper.adminLogs))
        .replace(queryParameters: queryParams);
    final response = await _apiService.get(uri.toString());
    return response.data ?? {};
  }
  ...
  Future<void> banUser(String userId, Duration duration) async {
    ...
    await _apiService.put(
      ApiRoutes.buildPath(ApiRoutesHelper.adminBanUser(userId)),
      data: body,
    );
  }
  @override
  Future<void> unbanUser(String userId) async {
    await _apiService.put(
      ApiRoutes.buildPath(ApiRoutesHelper.adminUnbanUser(userId)),
    );
  }
  Future<Map<String, dynamic>> deleteComment(String commentId,
    ...
    final response = await _apiService.delete(
      ApiRoutes.buildPath(ApiRoutesHelper.adminDeleteComment(commentId)),
      data: body,
    );
    return response.data ?? {};
  }
  Future<Map<String, dynamic>> deleteShort(String shortId,
    ...
    if (reason != null) body['reason'] = reason;
    final response = await _apiService.delete(
      ApiRoutes.buildPath(ApiRoutesHelper.adminDeleteShort(shortId)),
      data: body,
    );
    return response.data ?? {};
  }
  ...
  Future<Map<String, dynamic>> getJournalistsWithPressCards({
    ...
    final uri = Uri.parse(
            ApiRoutes.buildPath(ApiRoutesHelper.adminJournalistsPressCards))
        .replace(queryParameters: queryParams);
    final response = await _apiService.get(uri.toString());
    return response.data;
  }
  ...
  Future<void> toggleJournalistVerification(
    ...
    await _apiService.put(
      ApiRoutes.buildPath(
          ApiRoutesHelper.adminToggleJournalistVerification(journalistId)),
      data: {'verify': verify},
    );
  }
  @override
  Future<List<Report>> getReports({
    ...
    final uri = Uri.parse(ApiRoutes.buildPath(ApiRoutesHelper.adminReports))
        .replace(queryParameters: queryParams);
    final response = await _apiService.get(uri.toString());
  ...
  Future<void> reviewReport(
    ...
    await _apiService.put(
      ApiRoutes.buildPath(ApiRoutesHelper.adminReviewReport(reportId)),
      data: {
        'status': status,
  ...
  Future<void> deleteContent(String contentType, String contentId) async {
    await _apiService.delete(
      ApiRoutes.buildPath(
          ApiRoutesHelper.adminDeleteContent(contentType, contentId)),
    );
  }
