...
class UserListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isJournalist = user['isJournalist'] == true ||
        user['journalistRole'] != null ||
  ...
  Widget _buildAvatar(BuildContext context, String? avatarUrl,
      bool isJournalist, bool isVerified) {
    return Stack(
      children: [
        Container(
          width: 48,
  ...
  Widget _buildUserInfo(
      BuildContext context, String name, String username, bool isJournalist) {
    return Column(
