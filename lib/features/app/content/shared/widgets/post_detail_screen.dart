...
import 'package:thot/features/app/content/posts/articles/widgets/article_post.dart';
import 'package:thot/features/app/content/posts/videos/widgets/video_post.dart';
import 'package:thot/features/app/content/posts/podcasts/widgets/podcast_post.dart';
...
class _PostDetailScreenState extends State<PostDetailScreen>
  ...
  void initState() {
    super.initState();
    debugPrint(
        '🎬 POST_DETAIL_SCREEN - initState | postId: ${widget.initialPostId} | isFromFeed: ${widget.isFromFeed}');
    developer.log(
  ...
  Future<void> _loadInitialPost() async {
    if (!mounted) return;
    debugPrint(
        '🚀 POST_DETAIL_SCREEN - _loadInitialPost | postId: ${widget.initialPostId}');
    developer.log(
