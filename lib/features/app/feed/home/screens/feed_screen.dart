...
import 'package:thot/features/app/feed/home/widgets/feed_app_header.dart';
...
class _FeedListState extends State<_FeedList>
  ...
  void _navigateToPost(Post post) {
    debugPrint(
        '🚀 FEED_SCREEN - Navigate to post | ID: ${post.id} | Type: ${post.type}');
    ...
    try {
      if (post.type == PostType.question) {
        ...
        debugPrint(
            '📱 FEED_SCREEN - Pushing to Video Detail screen | Route: ${RouteNames.videoDetail}');
        GoRouter.of(context).push(
